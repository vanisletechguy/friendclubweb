...
user4 = User.create!(first_name:"Zack", last_name: "Wylde", email: "Wylde@gmail.com", password: "abcdef", avatar: File.open('https://s3.us-east-2.amazonaws.com/maja-fc-photobucket/zackwylde.jpg'))

#user1.save
user1.posts.create!(title: "Purple Hays all in my brain", content: "Lately things don't seem the same. Actin funny but I don't know why...", longitude: 33.33, latitude: 33.33, image: File.open('https://s3.amazonaws.com/maja-fc-photobucket/purplehays.jpeg'))
user2.posts.create!(title: "Got a new kitten", content: "It it so cute", longitude: 33.33, latitude: 32.33, image: File.open('https://s3.us-east-2.amazonaws.com/maja-fc-photobucket/kitten.jpeg'))
user3.posts.create!(title: "Teaching a crow to eat out of my mouth", content: "It bit my tongue", longitude: 33.33, latitude: 32.33, image: File.open('https://s3.us-east-2.amazonaws.com/maja-fc-photobucket/ozzyCrow.jpg'))
